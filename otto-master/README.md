...
当前为 **Phase 3 / 0.3.0 跨平台验收中**：Runtime、Message Bus、SQLite、FastAPI控制面、离线WebUI、OTA、mDNS和内嵌MQTT Broker已完成macOS本机联调。设备会话、MQTT协议翻译、动作闭环、语音云服务和真机接入仍属于后续Phase；Windows CI通过前不标记Phase 3完成。
